...
2. De klasse **<code>AfrikaansDobbelenComponent</code>** vormt de lijm tussen ons domein (Dobbelsteen) en de HTML pagina. Als de gebruiker iets wijzigt op de html pagina gaat het domein aangesproken worden en de web pagina aangepast worden. Voorbeeld: de gebruiker klikt op de knop "rol dobbelsteen". De AfrikaansDobbelenComponent gaat de methode rol aanspreken in de domeinklasse Dobbelsteen. Deze klasse bevat volgende properties/methodes
    ...
    - in de <code>constructor</code> maak je een nieuwe dobbelsteen aan
    - de methode <code>toHtml</code> geeft het dobbelsteen object in de index pagina weer
...
3. Het bestand <code>index.js</code> is het startpunt van onze applicatie. De <code>init</code> methode start de applicatie op door
    ...
    - de methode <code>toHtml</code> ervan aan te roepen zodat de dobbelsteen wordt weergegeven in de html pagina
    <br></br>
...
10. Pas de klasse <code>AfrikaansDobbelenComponent</code> aan
    ...
    - de <code>constructor</code>:
      - heeft 1 argument <code>spelers</code>. Dit bevat een array van spelers die het spel zullen spelen
      - maak een nieuw Spel object aan i.p.v. een Speler object.
    - event-handling
...
12. Pas de <code>init</code> functie aan.
    ...
    - geef de net gemaakte array door bij creatie van de AfrikaansDobbelenComponent 
        <br></br>
...
Declareer in OxoComponent.js een klasse <code>OxoComponent</code> met volgende members
    ...
    - in de constructor
      ...
      - overloop deze array <code>imgElementenen</code> en definieer de onclick event handler voor elk element (gebruik de arrow functions):
...
12. Pas de <code>toHtml</code> functie in <code>OxoComponent</code> aan zodat afhankelijk van de toestand van het spel, de juiste message weergegeven wordt: volgende speler/gelijkspel/winnaar. Veel speelplezier!
    <br></br>
